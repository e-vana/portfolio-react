    ...
    <div className="about-container">
      <div className="about-text">
        ...
        <div className="button-bar">
          <a href="https://github.com/e-vana" target="_blank"><img src="images/GitHub_Logo.png"></img></a>
          <a href="https://www.linkedin.com/in/evanvana/" target="_blank"><img src="images/linkedin.png"></img></a>
        </div>
      </div>
