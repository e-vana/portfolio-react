  ...
  const projects = [
    {
      ...
      para1: `A mortgage calculator built in VueJS.`,
    ...
    <div>
      ...
      <div className="content-container">
        <div className="about-container" id="about">
          <h1>About</h1>
          <p>
            I’m a self taught Javascript Developer with a background in
            electrical engineering and the radio broadcast world. I’ve spend
            several years in the commercial radio industry as a broadcast
            engineer supporting radio stations and IT infrastructure in south
            Florida. Due to the changing landscape of the radio industry, I’ve
            decided that transitioning into the web development world is a leap
            I want to take. I’ve been a hobby developer for many years and am
            looking to take the plunge into the industry full time.
          </p>
          <p>
            I'm primarily a Vue developer but I've started to get more
            acquainted with the React ecosystem. If I'm writing a backend I
            always reach for Express and MongoDB.
          </p>
          <p>
            Want to reach out? Feel free to contact me on{" "}
            <a href="https://www.github.com/e-vana">Github</a> or{" "}
            <a href="https://www.linkedin.com/in/evanvana/">LinkedIn</a>
          </p>
        </div>
